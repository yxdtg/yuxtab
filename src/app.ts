...
function updateTime() {
    ...
    let textTime: HTMLLabelElement = $("text-time");
...
function updateDate() {
    ...
    let textDate: HTMLLabelElement = $("text-date");
...
// 搜索
function btnSearch() {
    let searchSearch: HTMLSelectElement = $("select-search");
    let searchText: string = ($("input-search") as HTMLInputElement).value;
 ...
 * 搜索url列表
 */
const searchUrlList: { [name: string]: string } = {
